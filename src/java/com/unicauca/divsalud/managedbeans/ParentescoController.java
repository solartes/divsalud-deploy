...
public class ParentescoController implements Serializable {
    ...
    @EJB
    private com.unicauca.divsalud.sessionbeans.ParentescoFacade ejbFacade;
    private List<Parentesco> items = null;
    private Parentesco selected;
    ...
    public void setSelected(Parentesco selected) {
    ...
    private ParentescoFacade getFacade() {
        return ejbFacade;
    }

    public Parentesco prepareCreate() {
        selected = new Parentesco();
        initializeEmbeddableKey();
        return selected;
    }

    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("ParentescoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("ParentescoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("ParentescoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Parentesco getParentesco(java.lang.Integer id) {
        return getFacade().find(id);
    }

    public List<Parentesco> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<Parentesco> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
