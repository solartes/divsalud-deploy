...
import com.unicauca.divsalud.sessionbeans.EstratoFacade;
...
@Named("estratoController")
@SessionScoped
public class EstratoController implements Serializable {

    @EJB
    private com.unicauca.divsalud.sessionbeans.EstratoFacade ejbFacade;
    ...
    public Estrato getEstrato(java.lang.Integer id) {
    ...
    public static class EstratoControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getEstrato(getKey(value));
        }
