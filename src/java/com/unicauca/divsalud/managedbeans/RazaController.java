...
import com.unicauca.divsalud.sessionbeans.RazaFacade;
...
public class RazaController implements Serializable {
    ...
    @EJB
    private com.unicauca.divsalud.sessionbeans.RazaFacade ejbFacade;
    ...
    public Raza getRaza(java.lang.Integer id) {
    ...
    public static class RazaControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getRaza(getKey(value));
        }
